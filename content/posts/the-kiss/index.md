...
{{< snap-gallery
    src="images/the-kiss/intro-gallery"
>}}
...
{{< audio src="/audio/the-kiss/the-kiss-example-acid-resonance.mp3" >}}

Filter sweep with sawtooth:

{{< audio src="/audio/the-kiss/the-kiss-example-sawtooth-sweep.mp3" >}}

Envelope in free running mode:

{{< audio src="/audio/the-kiss/the-kiss-example-free-running.mp3" >}}

Triangle wave lead with reverb:

{{< audio src="/audio/the-kiss/the-kiss-example-lead.mp3" >}}
...
[![]()](https://kromftronics.com/wp-content/uploads/2024/07/as3320-datasheet-lowpass-1.png)
{{< figure 
